...
class TestStringTruncateTransform(unittest.TestCase):
    def test_truncate(self):
        ...
        self.assertEqual(transformer.transform("abcde", max_length=-5, append_ellipsis=True), "")
    ...
    def test_truncate_with_offset(self):
        ...
        self.assertEqual(transformer.transform("abcde", max_length=10, offset=-2, append_ellipsis=True), "de")
        self.assertEqual(transformer.transform("abcde", max_length=4, offset=1, append_ellipsis=True), "bcde")
        self.assertEqual(transformer.transform("abcde", max_length=3, offset=1, append_ellipsis=True), "...")
        self.assertEqual(transformer.transform("abcdef", max_length=4, offset=1, append_ellipsis=True), "b...")
    ...
    def test_truncate_with_ellipsis(self):
        ...
        self.assertEqual(transformer.transform("abcdef", max_length=6, append_ellipsis=True), "abcdef")
