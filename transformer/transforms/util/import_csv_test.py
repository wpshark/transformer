...
class TestUtilImportCSVTransform(unittest.TestCase):
    ...
    "line-item output": True
        ...
        # no headers - values missing, but not all delimited
        self.assertEqual(
        {"Error: Could not determine delimiter"
        },
        transformer.transform('https://drive.google.com/uc?export=download&id=1fTzQP3GhlJIVzubhr_MJRv1pbosE6LsM', True))
